...
import 'history_screen_winter.dart';
...
class HomeScreen1 extends StatefulWidget {
  ...
  const HomeScreen1({super.key, required this.username});
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              await Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) =>
                                      ProfileScreen1(username: widget.username),
                                ),
                              );
                            },
                            child: Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              await Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) =>
                                      NewTaskScreen1(username: widget.username),
                                ),
                              );
                              await _loadPreview();
                            },
                ...
                DecoratedBox(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: _isRewardsLoading
                          ? null
                          : _onViewRewardsPressed,
                      child: _isRewardsLoading
