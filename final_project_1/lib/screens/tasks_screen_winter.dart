...
import 'new_task_winter.dart';
import 'progress_screen_winter.dart';

class TasksScreen1 extends StatefulWidget {
  final String username;
  const TasksScreen1({super.key, required this.username});
...
class _TasksScreen1State extends State<TasksScreen1> {
  ...
  Future<void> _loadTasks() async {
    ...
    try {
      final serverTasks = await apiService.fetchTasks(username: widget.username);
      final filteredTasks = serverTasks.where((t) => !Task.isInTempCache(t.id!)).toList();
                ...
                children: [
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: CircleAvatar(
                          ...
                          child: ClipOval(
                            child: Image.asset('assets/images/witch.png', fit: BoxFit.cover),
                          ),
                        ),
                      ),
                    ],
                  ...
                  const Text(
                    ...
                    style: TextStyle(
                      ...
                      shadows: [
                        Shadow(offset: Offset(0, 3), blurRadius: 8, color: Colors.black54),
                      ],
                    ),
                  ),
                  ...
                  Expanded(
                    child: _isLoading
                        ? const Center(
                        child: CircularProgressIndicator(color: NotivaColors.panelBorder))
                              ...
                              Column(
                                children: tasks.map((task) {
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: NotivaColors.glacial.withOpacity(0.85),
                                      borderRadius: BorderRadius.circular(10),
                                      border: Border.all(
                                        color: NotivaColors.panelBorder.withOpacity(0.6),
                                      ),
                                    ),
                                    child: Row(
                                      children: [
                                        ...
                                        IconButton(
                                          icon: const Icon(Icons.edit, color: NotivaColors.bgTop),
                                          onPressed: () async {
                                            await Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (_) => NewTaskScreen1(
                                        ...
                                        IconButton(
                                          icon: const Icon(Icons.delete, color: NotivaColors.bgTop),
                  ...
                  _buildMainButton(
                    ...
                    onPressed: () async {
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => NewTaskScreen1(username: widget.username),
                        ),
                      );
                      _loadTasks();
                    },
                  ...
                  _buildMainButton(
                    ...
                    onPressed: () async {
                      await Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              ProgressScreen1(username: widget.username),
                        ),
                      );
                      _loadTasks();
                    },
