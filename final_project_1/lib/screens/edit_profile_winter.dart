...
class EditProfileScreen1 extends StatefulWidget {
  ...
  const EditProfileScreen1({super.key, required this.username});

  @override
  State<EditProfileScreen1> createState() => _EditProfileScreen1State();
}
...
class _EditableDisplayContainer1 extends StatelessWidget {
  const _EditableDisplayContainer1({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(icon, color: NotivaColors.buttonBottom, size: 22),
